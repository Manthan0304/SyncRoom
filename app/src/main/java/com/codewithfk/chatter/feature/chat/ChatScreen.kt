...
fun ChatScreen(navController: NavController, channelId: String, channelName: String) {
    ...
    Scaffold(
            containerColor = Color.Transparent // Ensures transparency
    ) {
...
fun CallButton(isVideoCall: Boolean, onClick: (ZegoSendCallInvitationButton) -> Unit) {
    AndroidView(factory = { context ->
        ...
        // Set custom background based on call type
        val drawableId = if (isVideoCall) R.drawable.baseline_call_24 else R.drawable.baseline_videocam_24
